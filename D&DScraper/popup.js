  ...
  printSpellsButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const openPrintWindow = (data) => {
        ...
        const suggestionbuttonHTML = `<a href="https://github.com/calvincruz/DnDSpellScraper/issues/new?template=feature_request.md&title=[Feature Request] Your Suggestion Title" target="_blank" class="button">
