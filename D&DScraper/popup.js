  ...
  printSpellsButton.addEventListener("click", async () => {
    ...
    try {
      ...
      const openPrintWindow = (data) => {
        ...
        const suggestionbuttonHTML = `<button id="suggestionbutton" class="button" onclick="window.open('https://github.com/calvincruz/DnDSpellScraper/issues/new?template=feature_request.md&title=[Feature Request] Your Suggestion Title', '_blank')">
